...
type Info struct {
	SystemUuid string `json:"system_uuid" orm:"system_uuid" description:"系统主键"` // 系统主键
	Keyword    string `json:"keyword"     orm:"keyword"     description:"系统键"`  // 系统键
	Value      string `json:"value"       orm:"value"       description:"系统值"`  // 系统值
}
