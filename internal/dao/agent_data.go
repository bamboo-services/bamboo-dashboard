...
import (
	"bamboo-dashboard/internal/dao/internal"
)

// internalAgentDataDao is internal type for wrapping internal DAO implements.
type internalAgentDataDao = *internal.AgentDataDao

// agentDataDao is the data access object for table agent_data.
// You can define custom methods on it to extend its functionality as you wish.
type agentDataDao struct {
	internalAgentDataDao
}

var (
	// AgentData is globally public accessible object for table agent_data operations.
	AgentData = agentDataDao{
		internal.NewAgentDataDao(),
	}
)
