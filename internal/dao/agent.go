...
// internalAgentDao is internal type for wrapping internal DAO implements.
type internalAgentDao = *internal.AgentDao
...
var (
	// Agent is globally public accessible object for table agent operations.
	Agent = agentDao{
		internal.NewAgentDao(),
	}
)
