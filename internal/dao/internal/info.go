...
// InfoDao is the data access object for table xf_info.
type InfoDao struct {
...
// InfoColumns defines and stores column names for table xf_info.
...
// infoColumns holds the columns for table xf_info.
